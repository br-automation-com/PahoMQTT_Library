...
#if defined(_SG4)
	#define thread_type unsigned long
	#define thread_id_type unsigned long
	#define thread_return_type void
	typedef thread_return_type (*thread_fn)(unsigned long);
	#define mutex_type unsigned long
	#define cond_type unsigned long
	#define sem_type unsigned long
	#define WINAPI
